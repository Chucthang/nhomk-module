...
<div class="type-9">
        <div class="container">
            ...
            <div class="left-column">
                ...
                <img src="./images/black-module-9.png" onclick="myFunction(this);">
                <img src="./images/blue-module-9.png" onclick="myFunction(this);">
                <img src="./images/red-module-9.png" onclick="myFunction(this);">
            </div>
            ...
            <div class="right-column">
                ...
                <div class="product-price">
                    ...
                    <div class="product_meta">
                        <span>SKU:2314</span>
                        <span>Categories: Featured, Jeans, On Sale, Women.</span>
                    </div>
                </div>
            </div>
        </div>
